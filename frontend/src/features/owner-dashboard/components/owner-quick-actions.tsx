...
import { Building2, DoorOpen, FileText, UserPlus } from 'lucide-react';
...
const ACTIONS = [
  ...
  {
    label: 'Add units',
    description: 'One at a time or in bulk',
    to: '/units/new',
    icon: DoorOpen,
  ...
  },
  {
    ...
    description: 'They set their own password',
    to: '/tenants/new',
    icon: UserPlus,
  ...
  },
  {
    ...
    description: 'Bill this month\u2019s rent',
    to: '/billing/invoices',
    icon: FileText,
...
OwnerQuickActions.displayName = 'OwnerQuickActions';
